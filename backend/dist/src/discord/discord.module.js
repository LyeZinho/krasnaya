...
const discord_dispatcher_service_1 = require("./discord-dispatcher.service");
...
exports.DiscordModule = DiscordModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [discord_dispatcher_service_1.DiscordDispatcherService],
        exports: [discord_dispatcher_service_1.DiscordDispatcherService],
    })
], DiscordModule);
