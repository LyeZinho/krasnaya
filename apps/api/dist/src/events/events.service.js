...
var EventHandlersService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.EventHandlersService = void 0;
...
let EventHandlersService = EventHandlersService_1 = class EventHandlersService {
    db;
    logger = new common_1.Logger(EventHandlersService_1.name);
    constructor(db) {
        this.db = db;
    }
    ...
    async findByGuild(guildId) {
        return this.db.query.eventHandlers.findMany({
            where: (0, drizzle_orm_1.eq)(schema.eventHandlers.guildId, guildId),
        });
    }
    async findById(id) {
        return this.db.query.eventHandlers.findFirst({
            where: (0, drizzle_orm_1.eq)(schema.eventHandlers.id, id),
        });
    }
    async findByEvent(guildId, event) {
        return this.db.query.eventHandlers.findMany({
            where: (0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema.eventHandlers.guildId, guildId), (0, drizzle_orm_1.eq)(schema.eventHandlers.event, event)),
        });
    }
...
exports.EventHandlersService = EventHandlersService;
exports.EventHandlersService = EventHandlersService = EventHandlersService_1 = __decorate([
