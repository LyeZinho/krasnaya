...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(mgmt)/cards/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/10.BDchjIA9.css"];
export const fonts = [];
