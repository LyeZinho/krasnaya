import * as universal from '../entries/pages/(mgmt)/commands/_id_/_page.ts.js';

export const index = 12;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(mgmt)/commands/_id_/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(mgmt)/commands/[id]/+page.ts";
...
export const stylesheets = ["_app/immutable/assets/BrutalModal.CGTLEdkT.css"];
export const fonts = [];
